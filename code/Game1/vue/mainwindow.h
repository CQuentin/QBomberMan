...
/*! \class MainWindow
 * \brief classe gérant l'affichage et le déroulement du jeu
...
private:
    ...
    QVector <Joueur*> personnages;              /*!< ensemble des Joueur */
    int largeur;                                /*!< largeur de la vue */
    int hauteur;                                /*!< hauteur de la vue */
    int largeurG;                               /*!< largeur de la grille */
    int hauteurG;                               /*!< hauteur de la grille */
    int tailleC;                                /*!< taille d'une case de la grille */
    QBasicTimer timer;                          /*!< timer rafraichissant la position, la présence et l'image des différents éléments du jeu */
    int gravity;                                /*!< distance parcouru lors d'une chute ou d'un saut */
    int baseGravity;                            /*!< valeur absolue de gravity (gravity peut passer à 0, et changer de signe) */
    ToucheClavier *controleur;
    QVector<QVector<Brique*> > grilleBrique;    /*!< matrice de Brique représentant une grille sur la scène */
    QVector<QVector<Bonus*> > grilleBonus;      /*!< matrice de Bonus représentant une grille sur la scène */
...
public:
    ...
    */
    ...
    /*!
     * \brief vérifie si le joueur se trouve sur un bonus, et gère son obtention si c'est le cas
     * \author Quentin CHEYNET
     */
    void checkBonus();

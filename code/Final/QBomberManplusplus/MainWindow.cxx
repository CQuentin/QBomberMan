...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent)
{
    ...
    setupUi(this);
    QRegExpValidator *revalUser = new QRegExpValidator(QRegExp("^J+[0-9]{2}$"), this);
    userLineEdit->setValidator(revalUser);

    QRegExpValidator *revalMessage = new QRegExpValidator(QRegExp("^[0-9]{2}\ [0-9]{2}$"), this);
    sayLineEdit->setValidator(revalMessage);
